...
class PipelineControls(QWidget):
    ...
    def init_ui(self):
        ...
        self.btn_normalize.setToolTip("Normalize scale and position of sprite animations.")
    ...
    def run_process(self) -> None:
        ...
        if not self.current_asset or not self.current_asset_path: return
        
        video_path = os.path.join(self.current_asset_path, "videos", f"{self.current_asset}.mp4")
    ...
    def run_normalize(self) -> None:
        ...
        self.start_worker(normalize_asset, "Normalizing animations...", asset_dir=self.current_asset_path)
    ...
    def on_finished(self, success, output):
        ...
        if success:
            ...
            QMessageBox.information(self, "Success", "Pipeline script completed successfully.")
