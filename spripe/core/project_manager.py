...
from spripe.core.project_services import WorkspaceRegistry, ProjectMetadataService, FileSystemService
...
class ProjectManager:
    ...
    def create_asset(self, project_name: str, asset_name: str, external_path: Optional[str] = None):
    ...
    def rename_virtual_folder(self, project_name: str, old_name: str, new_name: str) -> bool:
    ...
    def delete_virtual_folder(self, project_name: str, folder_name: str, delete_assets: bool = False):
        meta = self.get_project_metadata(project_name)
        folders = meta.get("folders", [])
    ...
    def create_animation_from_video(self, project_name: str, asset_name: str, animation_name: str, video_path: str) -> str:
        return self.fs.create_animation_from_video(project_name, asset_name, animation_name, video_path)
        
    def create_animation_from_pngs(self, project_name: str, asset_name: str, animation_name: str, png_dir_path: str) -> str:
        return self.fs.create_animation_from_pngs(project_name, asset_name, animation_name, png_dir_path)

    def export_item(self, project_name: str, asset_name: str, animation_name: str, dest_path: str, export_type: str):
        self.fs.export_item(project_name, asset_name, animation_name, dest_path, export_type)
