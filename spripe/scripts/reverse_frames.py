...
def reverse_sequence(directory, prefix=""):
    ...
    print(f"Successfully reversed order for {len(temp_files)} files in '{os.path.basename(directory)}'.")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Reverse the order of an image sequence.")
